...
def myNetwork():
    ...
    ap1 = net.addAccessPoint('ap1', cls=OVSKernelAP, mac='00:00:00:00:00:01', ssid='ap1-ssid', channel='1', mode='g', position='1500.0,2000.0,0', range=500)
    ap2 = net.addAccessPoint('ap2', cls=OVSKernelAP, mac='00:00:00:00:00:02', ssid='ap2-ssid', channel='6', mode='g', position='3000.0,2000.0,0', range=500)
    ap3 = net.addAccessPoint('ap3', cls=OVSKernelAP, mac='00:00:00:00:00:03', ssid='ap3-ssid', channel='11', mode='g', position='4200.0,2000.0,0', range=500)

    info( '*** Adding hosts/stations\n')
    h1 = net.addHost('h1', cls=Host, ip='10.0.0.1', defaultRoute=None)
    h2 = net.addHost('h2', cls=Host, ip='10.0.0.2', defaultRoute=None)
    h3 = net.addHost('h3', cls=Host, ip='10.0.0.3', defaultRoute=None)
    sta1 = net.addStation('sta1', ip='10.0.0.4', position='300.0,450.0,0.0', range=300)
    ...
    # c0.cmd('wireshark -i con-eth0 -k &')
    sta1.cmd('xterm -hold -e python sta1.py')
    # c0.cmd('./sta1.py &')
    # c0.cmd('gnome-terminal -- python sta1.py')
