...
def myNetwork():
    ...
    ap1 = net.addAccessPoint('ap1', cls=OVSKernelAP, mac='00:00:00:00:00:01', ip='10.0.0.4', ssid='ap1-ssid', channel='1', mode='g', position='3000.0,2000.0,0', range=2000)
    ap2 = net.addAccessPoint('ap2', cls=OVSKernelAP, mac='00:00:00:00:00:02', ip='10.0.0.5', ssid='ap2-ssid', channel='6', mode='g', position='7500.0,2000.0,0', range=2000)
    ap3 = net.addAccessPoint('ap3', cls=OVSKernelAP, mac='00:00:00:00:00:03', ip='10.0.0.6', ssid='ap3-ssid', channel='11', mode='g', position='12000.0,2000.0,0', range=2000)
    ...
    sta1 = net.addStation('sta1', ip='10.0.0.7', mac='00:00:00:00:00:07', position='300.0,450.0,0.0', range=1000)
    ...
    info( '*** Plotting graph\n')
    net.plotGraph(max_x=14000, max_y=4000)

    info( '*** Starting mobility\n')
    net.startMobility(time=0, repetitions=1, ac_method='ssf')
    net.mobility(sta1, 'start', time=40, position='0.0,2050.0,0.0')
    net.mobility(sta1, 'stop', time=500, position='14000.0,2050.0,0.0')
    net.stopMobility(time=501)
    ...
    # c0.cmd('wireshark &')
    h1.cmd('xterm -hold -e ping 10.0.0.7 &')
    sta1.cmd('xterm &')
    h1.cmd('xterm -hold -e iperf -s -t 200 &')
